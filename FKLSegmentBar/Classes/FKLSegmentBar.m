...
@property (nonatomic, strong) FKLSegmentBarConfigure *config;

@end

@implementation FKLSegmentBar

#pragma mark - 接口
+ (instancetype)segmentBarWithFrame: (CGRect)frame {
    FKLSegmentBar *segmentBar = [[FKLSegmentBar alloc] initWithFrame:frame];
...
- (FKLSegmentBarConfigure *)config {
    if (!_config) {
        _config = [FKLSegmentBarConfigure defaultConfig];
    }
    return _config;
}
